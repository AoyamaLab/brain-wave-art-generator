...
[http://133.27.114.107/](http://133.27.114.107/) で体験ができます．
...
GitHubからプロジェクトをクローン（ダウンロード）します：

```bash
git clone https://github.com/your-username/brain-wave-art-generator.git
cd brain-wave-art-generator
```

Gitが使用できない場合は、GitHubページから「Code」→「Download ZIP」でダウンロードし、解凍してください。
